window.onload= function() {
    ...
    var arr = ['#F59562','#62DCF3','#F8BB60','#FFAFBA','#7962FB','#FFC1C1'];
    //2. 插入 ol 里面的li
    ...
    box.style.backgroundColor = arr[0];
    ...
    for(var i=0;i<olLis.length;i++) {
        ...
        olLis[i].onmouseover = function() {
            ...
            box.style.backgroundColor = arr[this.index];
            btn.style.backgroundColor = arr[this.index];
        }
    }
   // 4. 定时器部分  难点
    var timer = null;  // 定时器
    ...
    function autoplay() {
        ...
        box.style.backgroundColor = arr[key];
        btn.style.backgroundColor = arr[key];
    }
